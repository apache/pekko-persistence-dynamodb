...
import DynamoDBLoadSpec._

class DynamoDBLoadSpec extends TestKit(ActorSystem("test")) with ImplicitSender with WordSpecLike with Matchers with DynamoDBSpec {
